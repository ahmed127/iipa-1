...
@section('title', __('lang.the_not_authorized_companies'))

@section('content')
    @include('website.layout._header_page', [
        'title' => __('lang.the_not_authorized_companies'),
        'pageName' => __('lang.the_not_authorized_companies'),
        'heroImage' => asset('website/images/authorized_companies.jpg'),
    ])
                ...
                <div class="col-lg-2 col-sm-12">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('search_term', request('search_term') ?? '', [
                            'class' => 'form-control border border-end-0 direction-input-rtl
                                                            direction-input-ltr',
                        ...
                        {!! Form::button('<i class="fa-solid fa-magnifying-glass fa-sm text-primary"></i>', [
                            'type' => 'submit',
                            'class' => 'input-group-text bg-white border border-start-0 direction-span-rtl
                                                            direction-span-ltr',
                        ]) !!}
                    </div>
                    {!! Form::close() !!}
