                    ...
                    <div class="row p-3 gx-1">
                        <div class="col-lg-6 col-sm-3 my-lg-0 my-2">
                            <div class="input-group">
                                <input type="text" class="form-control border border-end-0" type="search"
                    ...
                    <div class="shadow-custom bg-white h-100">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination p-3">
                                ...
                                <li class="page-item px-1"><a class="page-link bg-primary text-white rounded-2"
                                        href="#">1</a>
                                </li>
                                <li class="page-item px-1"><a
                                        class="page-link bg-opacity-50 bg-secondary text-white rounded-2" href="#">2</a>
                                </li>
                                <li class="page-item px-1"><a
                                        class="page-link bg-opacity-50 bg-secondary text-white rounded-2" href="#">3</a>
                                </li>
                                <li class="page-item px-1"><a
                                        class="page-link bg-opacity-50 bg-secondary text-white rounded-2"
                                        href="#">...</a></li>
