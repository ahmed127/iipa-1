...
@section('title', __('lang.the_authorized_companies'))

@section('content')
    @include('website.layout._header_page', [
        'title' => __('lang.the_authorized_companies'),
        'pageName' => __('lang.the_authorized_companies'),
        ...
        <div class="container-fluid">
            <div class="row p-3 align-items-center">
                ...
                <div class="col-lg-2 col-sm-12">
                    {!! Form::open(['route' => 'website.authorized_companies_search']) !!}
