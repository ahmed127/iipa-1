    ...
    <div class="shadow-custom rounded-4 m-5 bg-white">
        <form action="{{ route('website.update_information') }}" method="POST">
            ...
            <div class="row gx-0 p-3">
                ...
                <div class="col-lg-6 col-sm-12 text-lg-end text-center py-3 px-2">
                    <a href="{{ route('website.profile') }}"
                        class="btn btn-light rounded-4 px-lg-5 px-3 py-2 w-auto shadow-custom">
                        Profile
                    </a>
                </div>
                ...
                <div class="col-lg-12 col-md-12 px-2 mb-3 fs-6">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control border border-end-0 text-start py-3" id="password">
                        <span class="input-group-text bg-white border border-start-0" id="basic-addon1">
                            <i class="fa-solid fa-eye text-secondary opacity-50 fa-sm"></i>
                        </span>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 px-2 mb-3 fs-6">
                    ...
                    <div class="input-group">
                        <input type="password_confirmation" class="form-control border border-end-0 text-start py-3"
