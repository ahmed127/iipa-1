...
@section('content')
    ...
    <section class="">
        <div class="container-fluid p-0">
            ...
            @php
                $source = "https://www.google.com/maps/embed?pb=$information_app->location_lat,$information_app->location_long&z=zoom&output=embed";
            @endphp
            {{-- {{ dd($source) }} --}}
                ...
                <div class="shadow-custom rounded-4 bg-white">
                    <div class="row gx-0 p-3">
                        ...
                        <div class="col-12 px-2 mb-3 fs-6">
                            ...
                            <div class="input-group">
                                <textarea name="message" class="form-control border py-3 rounded-4 shadow-sm" id="message"
                                    ></textarea>
                            </div>
                        </div>
