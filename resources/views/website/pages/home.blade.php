...
<section style="background-image: url({{ asset('website') }}/images/slider.png); background-size: cover; height: 70vh;">
    <div class="container-fluid h-100 p-0 d-flex align-items-center ">
        <div class="swiper px-4 mySwiper text-white">
            <div class="swiper-wrapper m-0">
                <div class="swiper-slide">
                    ...
                    <button type="button" class="btn btn-primary btn-lg rounded-4 px-5">
            ...
            <!-- {{-- <span class="d-lg-flex align-items-center gap-4 w-50 swiper-button position-absolute d-none">
                <!-- <div class="swiper-pagination"></div>
                <span class="d-flex gap-2">
                    <div class="swiper-button-next text-white"><i class="fa-sharp fa-solid fa-arrow-right"></i>
                    </div>
                    <div class="swiper-button-prev text-white"><i class="fa-solid fa-arrow-left"></i></div>
                </span> -->
            </span> --}} -->
        ...
        <div class="col-lg-8 col-sm-12 mx-lg-auto mx-2">
            <span class="w-75 px-5 text-wrap">
                ...
                <div class="d-flex  align-items-center">
                    <span> <img class="w-100" src="{{ asset('website') }}/images/company-3.png" alt="company-3"> </span>
                    <span class="vr mx-3"></span>
                    <span> <img class="w-100" src="{{ asset('website') }}/images/company-2.png" alt="company-2"> </span>
                    <span class="vr mx-3"></span>
                    <span> <img class="w-100" src="{{ asset('website') }}/images/company-1.png" alt="company-1"> </span>
                </div>
