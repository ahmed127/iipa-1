                ...
                <div class="col-md-12 my-md-0">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <a href="{{ route('adminPanel.events.index') }}"
...
<table class="table table-bordered table-hover" id="kt_datatableasd">
    <thead>
        <tr>
            ...
            <th>@lang('models/events.fields.open_calendar')</th>
                ...
                <td>
                    <label class="checkbox">
                        <input type="checkbox" class="check_inputs inputs-permmission control-input"
                            value="{{ $event->id }}" name="export_rows[]">
                        <span></span>
                    </label>
                </td>
                <td>{{ $event->title }}</td>
                <td>{{ $event->brief }}</td>
                <td>{{ $event->open_calendar ? __('lang.yes') : __('lang.no') }}</td>
                <td>{{ $event->date }}</td>
                <td>
                    ...
                    <div class='btn btn-sm-group'>
                        ...
                        @endcan
                        @can('events edit')
                            <a href="{{ route('adminPanel.events.edit', [$event->id]) . '?languages=en' }}"
                        ...
                        @can('events destroy')
                            ...
                            <button type="button" class="btn btn-sm btn-shadow mx-1 btn-transparent-danger"
                                data-toggle="modal" data-target="#country-{{ $event->id }}-modal">
...
@can('events destroy')
    @foreach ($events as $event)
        <!-- Modal -->
        <div class="modal fade" id="country-{{ $event->id }}-modal" tabindex="-1" role="dialog"
            aria-labelledby="country-{{ $event->id }}" aria-hidden="true">
