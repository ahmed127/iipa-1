                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            @include('adminPanel.inc._request_reply_mail', [
                                'email' => $individualTraining->email,
                            ])
                            {!! Form::model($individualTraining, [
                                'route' => ['adminPanel.individualTrainings.update', $individualTraining->id],
                                'method' => 'patch',
                                'class' => 'col-6',
                            ]) !!}
                            {!! Form::select('status', \App\Models\Follow::status_types(), $individualTraining->status, [
                                'class' => 'form-control',
                            ]) !!}
