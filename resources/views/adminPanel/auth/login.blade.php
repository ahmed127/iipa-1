...
<head>
    ...
    <link rel="shortcut icon" href="{{\App\Models\Setting::first()->logo_thumbnail_path}}" />
        ...
        <div class="bg-white login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid" id="kt_login">
            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #1e1e2d;">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <a href="#" class="mb-10 text-center">
                        <img onError="this.onerror=null;this.src='{{asset('uploads/images/original/default.png')}}';" src="{{\App\Models\Setting::first()->logo_thumbnail_path}}" class="max-h-70px" alt="" />
                    </a>
                    <!--end::Aside header-->

                    <!--begin::Aside title-->
                    <h3 class="text-center font-weight-bolder font-size-h4 font-size-h1-lg" style="color: #fff;">
                        AdminPanel<br /> with great build tools
                    </h3>
                    <!--end::Aside title-->
                </div>
                <!--end::Aside Top-->
            ...
            <div class="mx-auto overflow-hidden login-content flex-row-fluid d-flex flex-column justify-content-center position-relative p-7">
                        ...
                        <form action="{{ route('adminPanel.postLogin') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    <label class="pt-5 font-size-h6 font-weight-bolder text-dark">@lang('auth.password')</label>
                                </div>
                ...
                <div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
                    <a href="#" class="ml-10 text-primary font-weight-bolder font-size-h5">{{date('Y')}}&copy; {{ __('lang.iipa') }}</a>
                </div>
                <!--end::Content footer-->
            </div>
            <!--end::Content-->
