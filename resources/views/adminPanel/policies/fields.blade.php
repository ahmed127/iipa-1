    ...
    @foreach (config('langs') as $locale => $name)
        <div class="inner flex-column col-6">
            ...
            <div class="form-group col-sm-12">
                {!! Form::label('title', __('models/policies.fields.title') . ':') !!}
                {!! Form::text($locale . '[title]', isset($policy) ? $policy->title ?? '' : '', [
                    'class' => 'form-control',
                ]) !!}
            </div>
            ...
            <!-- Brief Field -->
            <div class="form-group col-sm-12">
                {!! Form::label('brief', __('models/policies.fields.brief') . ':') !!}
                {!! Form::text($locale . '[brief]', isset($policy) ? $policy->brief ?? '' : '', [
                    'class' => 'form-control',
                ]) !!}
            </div>
            ...
            <!-- Description Field -->
            <div class="form-group col-sm-12">
                {!! Form::label('description', __('models/policies.fields.description') . ':') !!}
                {!! Form::text($locale . '[description]', isset($policy) ? $policy->description ?? '' : '', [
                    'class' => 'form-control',
                ]) !!}
            </div>
...
<div class="form-group col-sm-12">
    ...
    <div class="image-input image-input-outline" id="kt_image_4"
        ...
        <div class="image-input-wrapper"
            style="background-image: url('{{ $policy->photo_original_path ?? '' }}'); width:800px;height:300px">
        </div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('adminPanel.policies.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
</div>
