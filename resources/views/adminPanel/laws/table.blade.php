                ...
                <div class="col-md-12 my-md-0">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <a href="{{ route('adminPanel.laws.index') }}"
                    ...
                    <div class='btn btn-sm-group'>
                        ...
                        @can('laws destroy')
                            ...
                            <button type="button" class="btn btn-sm btn-shadow mx-1 btn-transparent-danger"
                                data-toggle="modal" data-target="#country-{{ $law->id }}-modal">
...
@can('laws destroy')
    @foreach ($laws as $law)
        <!-- Modal -->
        <div class="modal fade" id="country-{{ $law->id }}-modal" tabindex="-1" role="dialog"
            aria-labelledby="country-{{ $law->id }}" aria-hidden="true">
