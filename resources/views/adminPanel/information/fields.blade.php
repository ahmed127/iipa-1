            ...
            <div class="form-group col-sm-6">
                ...
                <div class="image-input image-input-outline" id="kt_image_{{ $i }}"
                    ...
                    <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                        ...
                        <input type="file" name="{{ $locale }}[logo]" accept=".png, .jpg, .jpeg" />
...
<div class="form-group col-sm-6">
    ...
    <div class="image-input image-input-outline" id="kt_image_2" style="background-image: url({{asset('uploads/images/original/default.png')}})">
        <div class="image-input-wrapper" style="background-image: url('{{isset($information) ? asset('uploads/images/original/'. $information->logo_fav_icon) : ''}}')"></div>
