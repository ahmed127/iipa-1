...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('adminPanel.roles.updatePermissions') }}" class="btn btn-sm btn-success my-3 float-right">Update Permissions</a>
            ...
            <tr>
                <td>
                    ...
                    <label class="checkbox checkbox-outline checkbox-primary">
                        ...
                        <span></span>
                        <strong class="m-2">{{ Str::ucfirst($permission->page) }}:</strong>
                    </label>
                </td>
                {{-- <td>
