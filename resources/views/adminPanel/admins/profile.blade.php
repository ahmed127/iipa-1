        ...
        <div class="d-flex flex-row">
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href="{{ route('adminPanel.admins.password') }}" class="navi-link py-4">
                                    <span class="navi-icon mr-2">
                                        <span class="svg-icon">
            ...
            <div class="flex-row-fluid ml-lg-8">
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-toolbar">
                            <button class="btn btn-success mr-2"
                                onclick="document.getElementById('profile-update-form').submit()">Save
                                Changes</button>
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                    {!! Form::model($admin, ['route' => ['adminPanel.admins.update', $admin->id], 'method' => 'patch', 'id' => 'profile-update-form']) !!}
                    <!--begin::Body-->
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                ...
                                {!! Form::text('name', null, ['class' => 'form-control form-control-lg form-control-solid', 'maxlength' => 191]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="input-group input-group-lg input-group-solid">
                                    ...
                                    {!! Form::email('email', null, ['class' => 'form-control form-control-lg form-control-solid', 'maxlength' => 191]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
