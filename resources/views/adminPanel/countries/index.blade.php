    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{ route('adminPanel.countries.create')  . '?languages=' . \App::getLocale() }}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            ...
            <div class="pull-right mr-3">
                    @include('adminPanel.paginate', ['records' => $countries])
