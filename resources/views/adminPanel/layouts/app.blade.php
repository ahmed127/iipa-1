...
<head>
    ...
    @if (request()->segment(1) == 'ar')
        ...
        <!--begin::Page Vendors Styles(used by this page)-->
        <link href="{{ asset('metronic/assets/plugins/custom/datatables/datatables.bundle.rtl.css?v=7.0.6') }}"
            rel="stylesheet" type="text/css" />
        <!--end::Page Vendors Styles-->
        ...
        <link href="{{ asset('metronic/assets/plugins/global/plugins.bundle.rtl.css?v=7.0.6') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('metronic/assets/plugins/custom/prismjs/prismjs.bundle.rtl.css?v=7.0.6') }}"
            rel="stylesheet" type="text/css" />
    ...
    @else
        ...
        <!--begin::Page Vendors Styles(used by this page)-->
        <link href="{{ asset('metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.6') }}"
            rel="stylesheet" type="text/css" />
        <!--end::Page Vendors Styles-->

        <!--begin::Page Vendors Styles(used by this page)-->
        <link href="{{ asset('metronic/assets/plugins/custom/datatables/datatables.bundle.css?v=7.0.6') }}"
            rel="stylesheet" type="text/css" />
        <!--end::Page Vendors Styles-->

        <!--begin::Global Theme Styles(used by all pages)-->
        <link href="{{ asset('metronic/assets/plugins/global/plugins.bundle.css?v=7.0.6') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('metronic/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.6') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('metronic/assets/css/style.bundle.css?v=7.0.6') }}" rel="stylesheet" type="text/css" />
        <!--end::Global Theme Styles-->

        <!--begin::Layout Themes(used by all pages)-->
        <link href="{{ asset('metronic/assets/css/themes/layout/header/base/light.css?v=7.0.6') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('metronic/assets/css/themes/layout/header/menu/light.css?v=7.0.6') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('metronic/assets/css/themes/layout/brand/dark.css?v=7.0.6') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('metronic/assets/css/themes/layout/aside/dark.css?v=7.0.6') }}" rel="stylesheet"
            type="text/css" />
        <link href="{{ asset('css/app.css') }}" rel="stylesheet" type="text/css" />
    @endif
    <!--end::Layout Themes-->

    <link rel="shortcut icon" href="{{ \App\Models\Information::first()->logo_fav_icon_thumbnail_path }}" />
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed ">
        ...
        <a href="index.html">
            <img onError="this.onerror=null;this.src='{{ asset('uploads/images/original/default.png') }}';"
                alt="Logo"
                src="{{ \App\Models\Information::first()->translate(App::getLocale())->fav_icon_original_path }}"
                width="50px" />
        </a>
        <!--end::Logo-->
                                ...
                                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                    <div class="mr-1 btn btn-icon btn-clean btn-dropdown btn-lg">
                                        @if (request()->segment(1) == 'en')
                                            <img onError="this.onerror=null;this.src='{{ asset('uploads/images/original/default.png') }}';"
                                                class="rounded-sm h-20px w-20px"
                                                src="{{ asset('flags/226-united-states.svg') }}" alt="flag" />
                                        @else
                                            <img onError="this.onerror=null;this.src='{{ asset('uploads/images/original/default.png') }}';"
                                                class="rounded-sm h-20px w-20px" src="{{ asset('flags/saudi.svg') }}"
                                                alt="flag" />
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <ul class="py-4 navi navi-hover">
                                        ...
                                        <li class="navi-item">
                                            <a href="{{ $en }}" class="navi-link">
                                                <span class="mr-3 symbol symbol-20">
                                                    <img onError="this.onerror=null;this.src='{{ asset('uploads/images/original/default.png') }}';"
                                                        src="{{ asset('flags/226-united-states.svg') }}"
                                                        alt="flag" />
                                                </span>
                                                <span class="navi-text">@lang('models/dashboard.fields.english')</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                                        ...
                                        <li class="navi-item">
                                            <a href="{{ $ar }}" class="navi-link">
                                                <span class="mr-3 symbol symbol-20">
                                                    <img onError="this.onerror=null;this.src='{{ asset('uploads/images/original/default.png') }}';"
                                                        src="{{ asset('flags/saudi.svg') }}" alt="flag" />
                                                </span>
                                                <span class="navi-text">@lang('models/dashboard.fields.arabic')</span>
                                            </a>
                                        </li>
                                        <!--end::Item-->
                            ...
                            <div class="dropdown">
                                ...
                                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                    ...
                                    <div class="w-auto px-2 btn btn-icon btn-icon-mobile btn-clean d-flex align-items-center btn-lg"
                                        ...
                                        <span
                                            class="mr-1 text-muted font-weight-bold font-size-base d-none d-md-inline">@lang('models/dashboard.fields.hi'),</span>
                                        <span
                                            class="mr-3 text-dark-50 font-weight-bolder font-size-base d-none d-md-inline">{{ $admin }}</span>
                                        <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                            <span
                                                class="symbol-label font-size-h5 font-weight-bold">{{ ucfirst(substr($admin, 0, 1)) }}</span>
                                        </span>
                                    </div>
                                </div>
                                <!--end::Toggle-->
                                ...
                                <div
                                    ...
                                    <ul class="py-4 navi navi-hover">
                                        @can('admins profile')
                                            <!--begin::Item-->
                                            <li class="navi-item">
                                                <a href="{{ route('adminPanel.admins.profile') }}" class="navi-link">
                                                    <span class="mr-3 symbol symbol-20">
                                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                            <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Code\Settings4.svg--><svg
                                        ...
                                        @can('informations edit')
                                            <!--begin::Item-->
                                            <li class="navi-item">
                                                <a href="{{ route('adminPanel.information.edit', 1) . '?languages=en' }}"
                                                    class="navi-link">
                                                    <span class="mr-3 symbol symbol-20">
                                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                            <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Code\Settings4.svg--><svg
                                                    ...
                                                    <span class="navi-text">@lang('models/information.plural')</span>
                                                </a>
                                            </li>
                                            <!--end::Item-->
                                        @endcan
                        ...
                        <div
                            ...
                            <div class="flex-wrap mr-1 d-flex align-items-center">
                                ...
                                <div class="flex-wrap mr-5 d-flex align-items-baseline">
                                    <!--begin::Page Title-->
                                    {{-- <h5 class="my-1 mr-5 text-dark font-weight-bold"> Dashboard </h5> --}}
                                    <!--end::Page Title-->
                                    <!--begin::Breadcrumb-->
                                    @yield('breadcrumb')
                                    <!--end::Breadcrumb-->
                ...
                <div class="py-4 bg-white footer d-flex flex-lg-column " id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="order-2 text-dark order-md-1">
                            <span class="mr-2 text-muted font-weight-bold">{{ date('Y') }}&copy;</span>
                            <a href="{{ route('website.home') }}" target="_blank"
                                class="text-dark-75 text-hover-primary">{{ __('lang.iipa') }}</a>
                        </div>
                        <!--end::Copyright-->

                        <!--begin::Nav-->
                        <div class="nav nav-dark">
                            {{-- <a href="#" target="_blanck" class="pl-0 pr-5 nav-link">Powered Company</a> --}}
                        </div>
                        <!--end::Nav-->
                    </div>
                    <!--end::Container-->
    ...
    {{-- <script src="{{asset('metronic/assets/js/pages/crud/ktdatatable/base/translation.js?v=7.0.6')}}"></script> --}}
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#exportButton").click(function() {
                let IDs = $("input[ checked=checked]");
                if (IDs.length > 0) {
                    $('#export-data').submit();
                } else {
                    Swal.fire({
                        icon: "error",
                        title: "برجاء تحديد العناصر ",
                        timer: 2000,
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".type_switch").click(function() {
                var type_switch = $(this).attr('type-switch');
