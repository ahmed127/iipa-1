...
<head>
    ...
    <!--begin::Page Vendors Styles(used by this page)-->
    <link href="{{ asset('metronic/assets/plugins/custom/datatables/datatables.bundle.css?v=7.0.6') }}" rel="stylesheet"
        type="text/css" />
    <!--end::Page Vendors Styles-->
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed ">
        <!--begin::Logo-->
        <a href="index.html">
            <img onError="this.onerror=null;this.src='{{ asset('uploads/images/original/default.png') }}';" alt="Logo"
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div id="kt_header" class="header header-fixed">
                    ...
                    <div class=" container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <!--begin::Topbar-->
                        <div class="topbar">
                            @include('adminPanel.layouts._notifications')
                            <!--begin::Languages-->
                            <div class="dropdown">
                                <!--begin::Toggle-->
                            ...
                            <div class="dropdown">
                                ...
                                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                    ...
                                    <div class="w-auto px-2 btn btn-icon btn-icon-mobile btn-clean d-flex align-items-center btn-lg"
                                        ...
                                        <span
                                            class="mr-3 text-dark-50 font-weight-bolder font-size-base d-none d-md-inline">{{
                                            $admin }}</span>
                                        <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                            <span class="symbol-label font-size-h5 font-weight-bold">{{
                                                ucfirst(substr($admin, 0, 1)) }}</span>
                                        </span>
                                    </div>
                                </div>
                                <!--end::Toggle-->
