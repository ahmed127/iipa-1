...
<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
    <li class="breadcrumb-item">
        <a href="{{ route('adminPanel.regions.index') }}">@lang('models/regions.singular')</a>
    </li>
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{ route('adminPanel.regions.index') }}" class="btn btn-secondary font-weight-bolder">
                        ...
                        <div class="card-body">
                            @include('adminPanel.regions.show_fields')
                        </div>
                    </div>
                    <!--end::Card-->
                </div>
