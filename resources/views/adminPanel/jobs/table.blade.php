                ...
                <div class="col-md-12 my-md-0">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <a href="{{ route('adminPanel.jobs.index') }}"
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class='btn btn-sm-group'>
                            {{-- @can('jobs view')
                                <a href="{{ route('adminPanel.jobs.show', [$job->id]) }}"
                                    class='btn btn-sm btn-shadow mx-1 btn-transparent-success'>
                                    <i class="fa fa-eye"></i>
                                </a>
                            @endcan --}}
                        @can('jobs edit')
                            <a href="{{ route('adminPanel.jobs.edit', [$job->id]) . '?languages=en' }}"
                        ...
                        @can('jobs destroy')
                            ...
                            <button type="button" class="btn btn-sm btn-shadow mx-1 btn-transparent-danger"
                                data-toggle="modal" data-target="#country-{{ $job->id }}-modal">
...
@can('jobs destroy')
    @foreach ($jobs as $job)
        <!-- Modal -->
        <div class="modal fade" id="country-{{ $job->id }}-modal" tabindex="-1" role="dialog"
            aria-labelledby="country-{{ $job->id }}" aria-hidden="true">
