                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            @include('adminPanel.inc._request_reply_mail', [
                                'email' => $cooperativeTraining->email,
                            ])
                            {!! Form::model($cooperativeTraining, [
                                'route' => ['adminPanel.cooperativeTrainings.update', $cooperativeTraining->id],
                                'method' => 'patch',
                                'class' => 'col-6',
                            ]) !!}
                            {!! Form::select('status', \App\Models\Follow::status_types(), $cooperativeTraining->status, [
                                'class' => 'form-control',
                            ]) !!}
                            {!! Form::submit(__('crud.save'), ['class' => 'btn btn-primary mt-5']) !!}
