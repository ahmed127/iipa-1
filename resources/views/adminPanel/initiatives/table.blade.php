                    ...
                    {!! Form::open(['route' => 'adminPanel.initiatives.index', 'method'=>'GET']) !!}
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <a href="{{ route('adminPanel.initiatives.index') }}" class="btn btn-light-danger font-weight-bold">@lang('crud.reset')</a>
...
<table class="table table-bordered table-hover" id="kt_datatableasd">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <label class="checkbox">
                    <input type="checkbox" class="check_inputs inputs-permmission control-input" value="{{ $initiative->id }}" name="export_rows[]">
                    <span></span>
                </label>
            </td>
            ...
            <td>
                ...
                <div class='btn btn-sm-group'>
                    ...
                    <a href="{{ route('adminPanel.initiatives.show', [$initiative->id]) }}" class='btn btn-sm btn-shadow mx-1 btn-transparent-success'>
                        <i class="fa fa-eye"></i>
                    </a>
                    @endcan
                    @can('initiatives edit')
                    <a href="{{ route('adminPanel.initiatives.edit', [$initiative->id]) . "?languages=en" }}" class='btn btn-sm btn-shadow mx-1 btn-transparent-primary'>
                        <i class="fa fa-edit"></i>
                    </a>
                    @endcan
                    @can('initiatives destroy')
                    {{-- {!! Form::button('<i class="fa fa-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-sm btn-shadow mx-1 btn-transparent-danger', 'onclick' => 'return confirm("'.__('crud.are_you_sure').'")']) !!} --}}
                    <button type="button" class="btn btn-sm btn-shadow mx-1 btn-transparent-danger" data-toggle="modal" data-target="#country-{{$initiative->id}}-modal">
...
<!-- Modal -->
<div class="modal fade" id="country-{{$initiative->id}}-modal" tabindex="-1" role="dialog" aria-labelledby="country-{{$initiative->id}}"
    aria-hidden="true">
