<div class="row">
    ...
    <div class="form-group col-lg-4 col-sm-12">
        ...
        <div class="radio-inline radio_switch" type-active='{{ old(' type', @optional($initiative)->type )== 2 ? 'pdf' :
            'page' }}'>
    ...
    <div class="col-lg-6 col-sm-12">
        ...
        <div class="form-group">
            ...
            {!! Form::text($locale . '[title]', isset($initiative)? $initiative->title ??'' : '', ['class' =>
            'form-control'])
            !!}
        </div>
        ...
        <div class="form-group ">
            ...
            {!! Form::text($locale . '[brief]', isset($initiative)? $initiative->brief ??'' : '', ['class' =>
            'form-control'])
            !!}
        </div>
        ...
        <div class="form-group type_page">
            ...
            {!! Form::text($locale . '[name]', isset($initiative)? $initiative->name ??'' : '', ['class' =>
            'form-control'])
            !!}
        </div>
        <!-- Meta Title Field -->
        <div class="form-group type_page">
            ...
            {!! Form::textarea($locale . '[meta_title]', isset($initiative)? $initiative->meta_title ??'' : '', ['class'
            =>
            'form-control'])
            !!}
        </div>
        <!-- Meta Title Field -->
        <div class="form-group type_page">
            {!! Form::label('meta_description', __('models/initiatives.fields.meta_description').'
            '.__('crud.'.$name).':') !!}
            {!! Form::textarea($locale . '[meta_description]', isset($initiative)? $initiative->meta_description ??'' :
            '',
            ['class' =>
            'form-control'])
            !!}
        ...
        <!-- Meta Title Field -->
        <div class="form-group type_page">
            {!! Form::label('meta_keywords', __('models/initiatives.fields.meta_keywords').' '.__('crud.'.$name).':')
            !!}
            {!! Form::textarea($locale . '[meta_keywords]', isset($initiative)? $initiative->meta_keywords ??'' : '',
            ['class' =>
            'form-control'])
            !!}
        </div>
        ...
        <div class="form-group type_page">
            ...
            {!! Form::textarea($locale . '[description]', isset($initiative)? $initiative->description ??'' : '',
            ['class'
            =>
            'form-control']) !!}
        </div>
        ...
        <div class="form-group type_page">
            {!! Form::label('strategic_goal', __('models/initiatives.fields.strategic_goal').' '.__('crud.'.$name).':')
            !!}
            {!! Form::textarea($locale . '[strategic_goal]', isset($initiative)? $initiative->strategic_goal ??'' : '',
            ['class'
            =>
            'form-control']) !!}
        </div>
        ...
        <div class="form-group type_page">
            ...
            {!! Form::textarea($locale . '[target_group]', isset($initiative)? $initiative->target_group ??'' : '',
            ['class'
            =>
            'form-control']) !!}
        </div>
