...
<div class="form-group show">
    ...
    <img onError="this.onerror=null;this.src='{{ asset('uploads/images/original/default.png') }}';" width="400"
        src="{{ asset('uploads/images/thumbnail/' . $slider->photo) }}" alt="{{ $slider->title }}">
</div>
