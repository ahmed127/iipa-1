...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{ route('adminPanel.recruitments.index') }}">@lang('models/recruitments.singular')</a>
        </li>
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($recruitment, [
                                'route' => ['adminPanel.recruitments.update', $recruitment->id],
                                'method' => 'patch',
                                'class' => 'col-6',
                            ]) !!}
                            {!! Form::select('status', \App\Models\Follow::status_types(), $recruitment->status, [
                                'class' => 'form-control',
                            ]) !!}
