...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{ route('adminPanel.consultings.index') }}">@lang('models/consultings.singular')</a>
        </li>
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($consulting, [
                                'route' => ['adminPanel.consultings.update', $consulting->id],
                                'method' => 'patch',
                                'class' => 'col-6',
                            ]) !!}
                            {!! Form::select('status', \App\Models\Follow::status_types(), $consulting->status, [
                                'class' => 'form-control',
                            ]) !!}
