<div class="row">
    <div class="col nav-tabs-boxed">
        ...
        <ul class="nav nav-light-success nav-pills" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link {{$request_lang == $locale ?'active':''}}" id="{{$name}}-tab" data-toggle="pill"
        ...
        <div class="tab-content mt-5" id="myTabContent">
            ...
            <div class="tab-pane fade {{$request_lang == $locale ?'show active':''}}" id="{{$name}}" role="tabpanel"
                aria-labelledby="{{$name}}-tab">

                <!-- Meta Title Field -->
                <div class="form-group col-sm-6">
                    {!! Form::label('meta_title', __('models/pages.fields.meta_title').':') !!}
                    {!! Form::text($locale . '[meta_title]', isset($meta)? $meta->translate($locale)->meta_title??'' :
                    '' , ['class'
                ...
                <div class="form-group col-sm-6">
                    ...
                    {!! Form::textarea($locale . '[meta_description]', isset($meta)?
                    $meta->translate($locale)->meta_description??'' :
                ...
                <div class="form-group col-sm-6">
                    ...
                    {!! Form::textarea($locale . '[meta_keywords]', isset($meta)?
                    $meta->translate($locale)->meta_keywords??'' : '' ,
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::text($locale . '[name]', isset($page)? $page->translate($locale)->name??'' : '' , ['class'
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::textarea($locale . '[content]', isset($page)? $page->translate($locale)->content??'' : ''
