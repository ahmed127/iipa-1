    ...
    <div class="flex-wrap pt-6 pb-0 border-0 card-header">
        <div class="card-title">
            <h3 class="card-label">
                ...
                <span class="pt-2 d-block text-muted font-size-sm">@lang('crud.descriptions')</span>
            </h3>
        </div>
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{ route('adminPanel.pages.create') . '?languages=' . \App::getLocale()}}" class="btn btn-primary font-weight-bolder">
