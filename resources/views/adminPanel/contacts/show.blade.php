                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('adminPanel.contacts.index') }}"
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::model($contact, ['route' => ['adminPanel.contacts.update',
                        $contact->id],
                        'method' => 'patch']) !!}
                        {!! Form::select('status', \App\Models\Follow::status_types(), $contact->status, ['class' =>
                        'form-control col-3']) !!}
