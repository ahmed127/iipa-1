...
<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
    <li class="breadcrumb-item">
        <a href="{{ route('adminPanel.cities.index') }}">@lang('models/cities.singular')</a>
    </li>
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="{{ route('adminPanel.cities.index') }}" class="btn btn-secondary font-weight-bolder">
                        ...
                        <div class="card-body">
                            @include('adminPanel.cities.show_fields')
                        </div>
                    </div>
                    <!--end::Card-->
                </div>
