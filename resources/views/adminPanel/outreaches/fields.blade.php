<div class="row">
    ...
    <div class="form-group col-lg-4 col-sm-12">
        ...
        <div class="radio-inline radio_switch" type-active='{{ old(' type', @optional($outreach)->type )== 2 ? 'pdf' :
            'page' }}'>
    ...
    <div class="form-group col-lg-4 col-sm-12 type_pdf">
        ...
        <p>
            <a href="{{ $outreach->attachment_pdf??''}}" target="_blank">
                File
            </a>
        </p>
        @endisset
    ...
    <div class="form-group col-lg-4 col-sm-12 type_page">
        ...
        {!! Form::text('btn_link', isset($outreach)? $outreach->btn_link ??'' : '', ['class' =>
        'form-control'])
        !!}
    </div>
    ...
    <div class="col-lg-6 col-sm-12">
        ...
        <div class="form-group type_page">
            ...
            {!! Form::text($locale . '[btn_name]', isset($outreach)? $outreach->btn_name ??'' : '', ['class' =>
            'form-control'])
            !!}
        </div>
        ...
        <div class="form-group">
            ...
            {!! Form::text($locale . '[title]', isset($outreach)? $outreach->title ??'' : '', ['class' =>
            'form-control'])
            !!}
        </div>
        ...
        <div class="form-group">
            ...
            {!! Form::text($locale . '[brief]', isset($outreach)? $outreach->brief ??'' : '', ['class' =>
            'form-control'])
            !!}
        </div>
        ...
        <div class="form-group type_page">
            ...
            {!! Form::text($locale . '[name]', isset($outreach)? $outreach->name ??'' : '', ['class' =>
            'form-control'])
            !!}
        </div>
        <!-- Meta Title Field -->
        <div class="form-group type_page">
            ...
            {!! Form::textarea($locale . '[meta_title]', isset($outreach)? $outreach->meta_title ??'' : '', ['class'
            =>
            'form-control'])
            !!}
        </div>
        <!-- Meta Title Field -->
        <div class="form-group type_page">
            {!! Form::label('meta_description', __('models/outreaches.fields.meta_description').'
            '.__('crud.'.$name).':') !!}
