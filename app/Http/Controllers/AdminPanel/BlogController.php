...
class BlogController extends AppBaseController
{
    ...
    {
        $blogCategories = BlogCategory::get()->pluck('title', 'id');
        return view('adminPanel.blogs.create', compact('blogCategories'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('adminPanel.blogs.edit', compact('blogCategories', 'blog'));
    }
